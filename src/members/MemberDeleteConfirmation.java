...
public class MemberDeleteConfirmation extends javax.swing.JFrame {
    ...
    public static void Start() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MemberDeleteConfirmation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MemberDeleteConfirmation deleteConfirmation = new MemberDeleteConfirmation();
            }
        });
    }
